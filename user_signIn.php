...
// $select_query_check_mail used for mail check is this mail is already exist or not // by yousaf
    $select_query_check_mail = mysqli_query($con ,"SELECT * FROM `user_registration` WHERE email = '$email'	&& password = $password");
...
// echo $row['id'];exit();
    ...
    {
      echo "<script>alert('Email Or Password dosenot match. Please try again');</script>";
    }
