...
<div class="container-xl">
  ...
  <form class="form-inline" method="post" action="search_approved_product.php">
...
<!-- // ********* END search code ************** -->
                       ...
                       <div class="col-sm-7" align="right">
                        ...
                        <a href="product_index.php" class="btn btn-secondary"><i class="material-icons"></i> <span>Go Back</span></a> 
            ...
            <table class="table table-striped table-hover">
                ...
                <tbody>
                     <?php
$ret=mysqli_query($con,"SELECT buy_product.ID,buy_product.status,buy_product.productid,user_registration.id, user_registration.fname,user_registration.lname,user_registration.profile_pic,user_registration.email,user_registration.mobile_no, buy_product.tax,buy_product.total_price,buy_product.bank_number,buy_product.sub_total,buy_product.location,buy_product.status FROM buy_product INNER JOIN user_registration ON buy_product.userid=user_registration.id where buy_product.status = 1 ");
$cnt=1;
