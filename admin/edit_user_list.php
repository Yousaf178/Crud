...
//echo $filename."show";
   ...
   // echo "update  user_registration set fname='$fname',lname='$lname', mobile_no='$contno', email='$email', password='$password',confirm_password='$confirm_password',profile_pic ='$filename', address='$add' where id='$eid'";exit();

  // Query for data insertion by yousaf
     $query=mysqli_query($con, "update  user_registration set fname='$fname',lname='$lname', mobile_no='$contno', email='$email', password='$password',confirm_password='$confirm_password',profile_pic ='$filename', address='$add' where id='$eid'");
...
<div class="signup-form">
 ...
 <?php
$eid=$_GET['editid'];
$ret=mysqli_query($con,"select * from user_registration where ID='$eid'");
...
?>
        ...
        <div class="form-group">
			<div class="row">
				<div class="col"><input type="text" class="form-control" name="fname" value="<?php  echo $row['fname'];?>" required="true"></div>
				<div class="col"><input type="text" class="form-control" name="lname" value="<?php  echo $row['lname'];?>" required="true"></div>
			</div>        	
        </div>
        ...
        <div class="col"><input type="text" class="form-control" name="mobile_no" value="<?php  echo $row['mobile_no'];?>" required="true" maxlength="10" pattern="[0-9]+"></div>
        ...
        <div class="form-group">
		 ...
		 <div class="form-group">
        	...
        	<img src="../user_image/<?php echo $row['profile_pic']; ?> " style="height: 100px;">
        </div>
		<div class="form-group">
      ...
      <?php 
        ...
        <button class="btn btn-secondary" onclick="history.back()"><a href="user_list.php"> Go Back</button>
    </div>
        </div>
