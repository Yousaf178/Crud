...
// $select_query_check_mail used for mail check is this mail is already exist or not // by yousaf
    $select_query_check_mail = mysqli_query($con ,"SELECT `Email` FROM `admin` WHERE Email = '$email'	");
...
if (mysqli_num_rows($select_query_check_mail) > 0) {
    	...
    	echo "<script type='text/javascript'> document.location ='insert_user.php'; </script>";
    }else{
...
//end 
    ...
    // echo "insert into admin(FirstName,LastName, MobileNumber, Email,password,confirm_password,profile_pic, Address) value('$fname','$lname', '$contno', '$email', '$password', '$confirm_password','$filename', '$add' )";exit();
  // Query for data insertion by yousaf
     $query=mysqli_query($con, "insert into admin(FirstName,LastName, MobileNumber, Email,password,confirm_password,profile_pic, Address) value('$fname','$lname', '$contno', '$email', '$password', '$confirm_password','$filename', '$add' )");
...
<div class="signup-form">
    <form  method="POST" action="" enctype="multipart/form-data">
        ...
        <div class="form-group">
			<div class="row">
				<div class="col"><input type="text" class="form-control" name="FirstName" placeholder="First Name" value="" required></div>
        ...
        <div class="form-group">
        	...
        	<div class="col"><input type="text" class="form-control" name="MobileNumber" placeholder="Enter your Mobile Number" required maxlength="10" pattern="[0-9]+"></div>
        </div>
        ...
        <div class="form-group">
        	<input type="file" class="form-control" name="profile_pic" placeholder="Enter profile pic" required>
        </div>
        <!-- end -->
		<div class="form-group">
