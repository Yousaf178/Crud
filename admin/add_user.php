...
//end 
    ...
    // echo "insert into user_registration(fname,lname, email,mobile_no,D_O_B,password,confirm_password,profile_pic, Address) value('$fname','$lname', '$email','$mobile_no','$D_O_B', '$password', '$confirm_password','$filename', '$add' )";exit;
  // Query for data insertion by yousaf
     $query=mysqli_query($con, "insert into user_registration(fname,lname, email,mobile_no,D_O_B,password,confirm_password,profile_pic, Address) value('$fname','$lname', '$email','$mobile_no','$D_O_B', '$password', '$confirm_password','$filename', '$add' )");
...
<div class="signup-form">
    <form  method="POST" action="" enctype="multipart/form-data">
        ...
        <div class="form-group">
        	...
        	<div class="col"><input type="text" class="form-control" name="mobile_no" placeholder="Enter your Mobile Number" required maxlength="10" pattern="[0-9]+"></div>
        </div>
        ...
        <div class="form-group">
        	<input type="date" class="form-control" name="D_O_B" placeholder="" required>
        </div>
...
</html><?php }else echo "<h1>Please login first .</h1>";header("Location:index.php"); ?>