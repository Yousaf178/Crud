    ...
    <div class="table-responsive">
        <div class="table-wrapper">
            <div class="table-title">
                <div class="row">
                    <div class="col-sm-5">
                        ...
                        $user_id_query = mysqli_query($con ,"SELECT * FROM `backupproduct`");
            ...
            <table class="table table-striped table-hover">
                ...
                <tbody>
                     <?php
$ret=mysqli_query($con,"select * from backupproduct");
$cnt=1;
...
<!--Fetch the Records -->
                    <tr style="background-color: ";>
                        ...
                        <td>
                            <a href="recover_product.php?delid=<?php echo $row['p_id']; ?>" class="btn btn-secondary"><i class="material-icons"></i> <span>Recover</span></a>
