            ...
            <div class="table-title">
                <div class="row">
                    ...
                    <div class="col-sm-9" align="right">
                        ...
                        <a href="product_index.php?userid=<?php echo $user_id; ?>" class="btn btn-secondary"><i class="material-icons"></i> <span>Back</span></a>
...
// ********* END search code **************
$ret=mysqli_query($con,"SELECT * FROM products where name='$name'");
$cnt=1;
