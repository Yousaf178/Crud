...
$userid = $_GET['userid'];
  ...
  // Query for data insertion by yousaf
     $query=mysqli_query($con, "insert into products(P_Id,U_id,name,image, made, price,quantity,from_date,to_date) value('$P_Id','$userid','$name','$filename','$made', '$price','$quantity','$from_date','$to_date' )");
...
$userid = $_GET['userid'];
    ...
    <script type='text/javascript'> document.location ='product_index.php?userid=<?php echo $userid; ?>'; </script>
  <?php }
  else
    {
...
<div class="signup-form">
    <form  method="POST" action="" enctype="multipart/form-data">
        ...
        <div class="col"><input type="text" class="form-control" name="P_Id" placeholder="Product S.no" value="" required></div>
    </div>
</div>
        <!-- end -->
