    ...
    <div class="table-responsive">
        <div class="table-wrapper">
            <div class="table-title">
                <div class="row">
                    <div class="col-sm-5">
                        ...
                        $user_id_query = mysqli_query($con ,"SELECT * FROM `admin` where id = $user_id");
                    ...
                    <h2><b>My Products List </b></h2>
                    </div>
                    <div class="col-sm-7" align="right">
                        <a href="insert_product.php?userid=<?php echo $user_id ?>" class="btn btn-secondary"><i class="material-icons">&#xE147;</i> <span>Add New Product</span></a>
                        <!-- <a href="sub_admin_product.php" class="btn btn-secondary"><i class="material-icons">&#xE147;</i> <span>My Products</span></a> -->
                        <a href="product_index.php" class="btn btn-secondary"><i class="material-icons">&#xE147;</i> <span>Back</span></a>
            ...
            <table class="table table-striped table-hover">
                ...
                <tbody>
                     <?php
$ret=mysqli_query($con,"select * from products where U_id = $user_id");
$cnt=1;
...
<!--Fetch the Records -->
                    <tr style="background-color: ";>
                        ...
                        <td><a href="product_detail.php?viewid=<?php echo $row['id'];?>"><img style="border-width: 10px; width: 82px;" src="../product_image/<?php echo $row['image']; ?> "></a> </td>
                        ...
                        <td><?php  //echo $row['price']; ?>
                            ...
                            <?php
                            if ($row['price'] > 1000) {
                                echo $row['price'] - $row['price'] /100 * 20 ;  
                            }else{
                              echo $row['price'];  
                            }
